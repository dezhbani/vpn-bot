...
const Plan = ({ plan, upgrade = false, setSelectedPlan }) => {
    ...
    return (
        <>
            ...
            <div onClick={handleClick} className="flex flex-col justify-around font-iran-sans bg-[#fff] shadow-[2px_4px_30px_0px_#00000010] rounded-2xl border-gray-300 hover:border-main-blue hover:border-2 border border-opacity-70 duration-100 w-92 max-h-[34rem] min-h-[34rem] md:mx-5 my-5 max-sm:mr-5 max-sm:ml-3 max-sm:my-5 p-10">
