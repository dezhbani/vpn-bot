...
const Configs = () => {
    ...
    return (
        <div className='h-screen'>
            ...
            {
                !loading &&
                <div className='flex z-20 dir-ltr h-[78%] w-[calc(100%-7.5rem)] sm:w-[calc(75%-3.5rem)] lg:w-[calc(80%-2rem)] xl:w-4/5 ml-4 mr-6 mt-28 mb-4 lg:mt-32 rounded-xl flex-wrap font-iran-sans'>
                    {
                        configs.length ?
