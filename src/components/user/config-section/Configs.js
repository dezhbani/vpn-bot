        ...
        <>
            ...
            <Modal isOpen={loading} loading={loading} />
            {
                configs.length && <div className='flex z-20 dir-ltr bg-white w-4/5 mx-5 mt-36 rounded-xl flex-wrap'>
                    <div className="flex items-center dir-ltr font-iran-sans mb-8 bg-[#fff] dark:bg-red-500 shadow-[2px_4px_30px_0px_#00000010] rounded-2xl border-opacity-70 duration-100 w-full min-h-20 my-2 px-5 [&>*]:p-4">
