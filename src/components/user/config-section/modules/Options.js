            ...
            <div className='w-full flex justify-between'>
                <div className='flex'>
                    ...
                    {/* <label class="inline-flex items-center relative">
                        <input class="peer hidden" id="toggle" type="checkbox" value={false} />
                        <div
                            class="relative w-20 h-9 bg-main-blue peer-checked:bg-main-blue/10 rounded-full after:absolute after:content-[''] after:w-7 after:h-7 after:bg-white after:rounded-full after:top-1 after:left-[5px] active:after:w-9 peer-checked:after:left-[76px] peer-checked:after:translate-x-[-100%] shadow-sm duration-300 after:duration-300 after:shadow-md"
                        ></div>
