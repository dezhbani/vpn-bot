...
const Options = ({ plan, configID, config, setReload, reload }) => {
    ...
    return (
        <>
            ...
            <Upgrade configID={configID} setOpenUpgrade={setOpenUpgrade} openUpgrade={openUpgrade} setReload={setReload} reload={reload} />
            <div className='w-full flex justify-between'>
                ...
                <div className='flex items-center'>
                    ...
                    <p className="flex w-fit items-center justify-center text-base max-sm:hidden text-main-blue bg-main-blue/10 px-4 py-2 mx-3 rounded-md" onClick={handleOpenUpgrade}>ارتقا کانفیگ</p>
