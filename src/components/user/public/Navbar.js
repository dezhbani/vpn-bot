    ...
    return (
        // <div className='h-full w-full pt-8 z-40 fixed top-0'>
            // <div className='bg-[#fff]/50 backdrop-blur-sm w-full'>
                <div className={`flex bg-white m-4 lg:mt-8 z-80 fixed top-0 ${menu?'w-[calc(50%-3.5rem)]': 'w-[calc(100%-7.5rem)]'} sm:w-[calc(75%-3.5rem)] lg:w-[calc(80%-2rem)] xl:w-4/5 shadow-[2px_4px_30px_0px_#00000010] rounded-xl`}>
