...
const Sidebar = () => {
    ...
    return (
        ...
        <Modal isOpen={!user} loading={!user}/>
            <Navbar />
            <div className={`${true ? 'w-1/2' : 'w-[4.5rem]'} m-8 rounded-xl shadow-[2px_4px_30px_0px_#00000010] h-[92%] bg-white z-50 dir-rtl fixed right-0 float-right sm:w-1/4 lg:w-1/6 xl:w-[15%]`}>
